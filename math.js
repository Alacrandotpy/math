...
let number_1 = prompt("Please choose a number."); 

// 4. Convert that value from a string to a floating point number

const floatnumber_1 = parseFloat(number_1); 

// 5. Repeat steps 3 and 4 to create a second variable and collect a second number

let number_2 = prompt("Please choose a second number."); 

const floatnumber_2 = parseFloat(number_2); 
const sum = (floatnumber_1 + floatnumber_2);
...
const message =  
  `<h1>Math with the numbers ${floatnumber_1} and ${floatnumber_2}.</h1>
   <h2>${floatnumber_1} + ${floatnumber_2} = ${floatnumber_1 + floatnumber_2}
   <br>
    ${floatnumber_1} * ${floatnumber_2} = ${floatnumber_1 * floatnumber_2}
   <br> 
    ${floatnumber_1} / ${floatnumber_2} = ${floatnumber_1 / floatnumber_2}
   <br> 
    ${floatnumber_1} - ${floatnumber_2} = ${floatnumber_1 - floatnumber_2}</h2>`; 
